...
This chapter will introduce REST servers and how software quality is ensured
today in the industry. It will also establish the challenges that arises.
...
So in summary: adherence to SOLID principles can be used to avoid rotten design
and in order to evaluate the readability a code review can be conducted. Thus a
good REST framework should be understood by other programmers and follow SOLID
principles.
